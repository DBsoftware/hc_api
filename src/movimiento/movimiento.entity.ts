...
export class Movimiento extends BaseEntity {
  ...
  @OneToMany(type => Alerta, alerta => alerta.movimiento, { eager: true })
  alertas: Alerta[];

  @ManyToOne(type => Presupuesto, presupuesto => presupuesto.movimientos, { eager: false })
  @JoinColumn({name: 'id_presupuesto', referencedColumnName: 'id'})
  presupuesto: Presupuesto;

  @ManyToOne(type => Subcategoria, subcategoria => subcategoria.movimientos, { eager: false })
